        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    <img src="Elemen.png" class="img_hero" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4 d-flex align-items-center">
                    <div class="iconWrapper d-flex justify-content-center align-items-center">
                        <img src="Vector.png" alt="" class="iconIngfo" srcset="">
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 d-flex align-items-center">
                    <img src="bg.png" class="about_img" alt="">
                </div>
                <div class="col-md-7">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card card_program shadow-lg">
                        <img src="Foto.png" class="card_img_program card-img-top" alt="">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card card_umkm shadow-lg">
                        <div class="card-body">
                            ...
                            <img src="anime.png" alt="" class="img_umkm">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <img src="foto_agenda.png" class="foto_agenda" alt="">
                            <div class="labelMain">
